...
import { EDUCATION } from '../commands/edu';
import { WORK_EXPERIENCE } from '../commands/work';
...
const COMMANDS = ["help", "about", "projects", "whoami", "repo", "banner", "clear", "resume", "edu", "work", "ls", "sudo", "rm -rf"];
